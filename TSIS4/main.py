...
if SOUND_ENABLED:
    try:
        sounds["eat"] = pygame.mixer.Sound("/Users/ismailkrut/PP2-1/TSIS4/eat.wav")
        sounds["power"] = pygame.mixer.Sound("/Users/ismailkrut/PP2-1/TSIS4/power.mp3")
        sounds["death"] = pygame.mixer.Sound("/Users/ismailkrut/PP2-1/TSIS4/death.wav")
...
def load_settings():
    try:
        return json.load(open("/Users/ismailkrut/PP2-1/TSIS4/settings.json"))
    except:
        return {
            "theme":"default",
            "grid": True,
