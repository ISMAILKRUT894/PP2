...
def menu(screen, font, small_font):
    ...
    draw_text(screen, "Q - Quit", small_font, (255,255,255), 120, 400)

def game_over(screen, font, small_font, score, distance):
    screen.fill((200,0,0))
    draw_text(screen, "ENTER NAME:", small_font, (255,255,255), 50, 225)
    draw_text(screen, "___________", small_font, (255,255,255), 200, 225)
    ...
    draw_text(screen, "ENTER TO CONTINUE", small_font, (255,255,255), 90, 380)
